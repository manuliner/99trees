...
| Deploy / rollback / ops | [DEPLOY.md](./DEPLOY.md) |
| Product UX / copy / acceptance (German) | [SCOPE.md](./SCOPE.md) → pick one `scope/*` leaf |
| Game rules / scoring | [scope/RULES.md](./scope/RULES.md) |
| Turn loop UX | [scope/FLOWS-PLAY.md](./scope/FLOWS-PLAY.md) |
| Crew / leaderboard UX | [scope/FLOWS-CREW-LEADERBOARD.md](./scope/FLOWS-CREW-LEADERBOARD.md) |
