...
CANON_SKILLS=(docs-shared docs-sync docs-commit docs-defrag docs-writer)
FORBIDDEN_NAMES=(hybrid docs-update docs-concepts)
...
if [[ ${#L1_PATHS[@]} -eq 0 ]]; then
  L1_PATHS=(docs/README.md README.md)
fi
