...
Review corpus: `AGENTS.md`, `CLAUDE.md`, `web/README.md`, `web/**/README.md`, `.vibe/docs/*.md`, `.cursor/rules/*.mdc`.

Check:

- One source of truth (no duplicate architecture across AGENTS + vibe + READMEs)
- Correct layers (commands in AGENTS only; no API trees in always-loaded files)
- Token density; dead paths (deleted components, old URLs)
- `AGENTS.md` doc index matches real paths
- `docs/SCOPE.md` not copied into agent codemaps
